...
export const getNavSections = (
  ...
  // We need to call the appropriate helper based on the interface type
  // This needs to be handled outside of this utility file where useLanguage is available
  return [];
};
