...
import DatabaseManagement from "./pages/admin/settings/DatabaseManagement";
          ...
          <TooltipProvider>
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/admin/settings/restaurant-profile" element={<RestaurantProfile />} />
                <Route path="/admin/settings/user-access" element={<UserAccess />} />
                <Route path="/admin/settings/printers-devices" element={<PrintersDevices />} />
                <Route path="/admin/settings/system-logs" element={<SystemLogs />} />
                <Route path="/admin/settings/integrations" element={<Integrations />} />
                <Route path="/admin/settings/database" element={<DatabaseManagement />} />
                <Route path="/admin/settings/language" element={<LanguageManagement />} />
                ...
                <Route path="/system/documentation" element={<Documentation />} />
