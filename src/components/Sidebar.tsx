...
export const Sidebar: React.FC<SidebarProps> = ({ open, onToggle }) => {
  ...
  const links = [
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="3" y="15" width="7" height="6" rx="1" stroke="currentColor" strokeWidth="2" />
          <rect x="14" y="3" width="7" height="6" rx="1" stroke="currentColor" strokeWidth="2" />
    ...
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M8 10V19" stroke="currentColor" strokeWidth="2" />
          <path d="M16 10V19" stroke="currentColor" strokeWidth="2" />
        </svg>
      ),
    },
    {
  ...
  return (
    <div
      className={cn(
        "h-screen bg-sidebar fixed left-0 top-0 z-10 flex flex-col border-r transition-all duration-300 ease-in-out",
        open ? "w-64" : "w-16"
      )}
    >
      <div className="p-4 flex justify-center items-center h-16 border-b">
        {open ? (
          <h1 className="text-xl font-bold text-sidebar-foreground">Habesha</h1>
        ) : (
