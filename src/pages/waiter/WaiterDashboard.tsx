  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      <PageHeader 
        ...
        description="Manage your tables, orders, and tasks"
      />
                ...
                <div key={order.id} className="p-4 flex justify-between items-center">
                  <div>
                    <div className="flex items-center gap-2">
                      <h4 className="font-medium">{order.table}</h4>
                      <Badge 
                        variant={
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                  <Card className="p-3 bg-primary/10 border-primary">
                    <div className="text-center">
                      ...
                      <Badge variant="outline" className="mt-1">Occupied</Badge>
                      <p className="text-xs text-muted-foreground mt-2">4 guests • 32m</p>
                  ...
                  <Card className="p-3 bg-amber-500/10 border-amber-500">
                    <div className="text-center">
                      ...
                      <Badge variant="outline" className="mt-1">Order Ready</Badge>
                      <p className="text-xs text-muted-foreground mt-2">2 guests • 15m</p>
                      <Button size="sm" className="w-full mt-3">
                        <T text="View" />
                      </Button>
                    </div>
                  ...
                  <Card className="p-3 bg-primary/10 border-primary">
                    <div className="text-center">
                      ...
                      <Badge variant="outline" className="mt-1">Occupied</Badge>
                      <p className="text-xs text-muted-foreground mt-2">6 guests • 45m</p>
                      <Button size="sm" className="w-full mt-3">
                        <T text="View" />
                      </Button>
                    </div>
                  ...
                  <Card className="p-3">
                    <div className="text-center">
                      ...
                      <Badge variant="secondary" className="mt-1">Preparing</Badge>
                      <p className="text-xs text-muted-foreground mt-2">3 guests • 22m</p>
                      <Button size="sm" className="w-full mt-3">
                        <T text="View" />
                      </Button>
                    </div>
                  ...
                  <Card className="p-3 bg-muted">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-muted-foreground mt-2">4 seats</p>
              ...
              <Card>
                ...
                <div className="divide-y">
                  <div className="p-4 flex justify-between items-center">
                    <div>
                      <h4 className="font-medium">Process end-of-shift report</h4>
                      <p className="text-sm text-muted-foreground mt-1">Due at end of shift</p>
                    </div>
                    <Button variant="outline" size="sm">
                      <T text="Complete" />
                    </Button>
                  ...
                  <div className="p-4 flex justify-between items-center">
                    <div>
                      <h4 className="font-medium">Restock service stations</h4>
                      <p className="text-sm text-muted-foreground mt-1">Due before dinner service</p>
                    </div>
                    <Button variant="outline" size="sm">
                      <T text="Complete" />
                    </Button>
                  ...
                  <div className="p-4 flex justify-between items-center">
                    <div>
                      <h4 className="font-medium">Assist with table setting</h4>
                      <p className="text-sm text-muted-foreground mt-1">Completed at 4:30 PM</p>
                    </div>
                    <Badge>
                      <T text="Completed" />
                    </Badge>
        ...
        <div className="lg:col-span-1">
          <Card className="mb-6">
            ...
            <div className="p-4 flex flex-col items-center">
              ...
              <p className="text-sm text-muted-foreground">Senior Waiter</p>
