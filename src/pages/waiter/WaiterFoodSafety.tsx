...
const WaiterFoodSafety = () => {
  ...
  const { data: templates = [], isLoading: isLoadingTemplates } = useChecklistTemplates("waiter");
    ...
    return (
      <Layout interface="waiter">
        <PageHeader
          ...
          description={<T text="Maintain cleanliness and hygiene standards" />}
        />
